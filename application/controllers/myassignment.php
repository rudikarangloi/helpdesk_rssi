...
function __construct(){
 ...
 function myassignment_list()
 {
        ...
        $sql_id_teksnisi = "SELECT id_teknisi FROM teknisi WHERE nik = '$id_user'";
        $row_id_teksnisi = $this->db->query($sql_id_teksnisi)->row();

        $id_teksnisi = $row_id_teksnisi->id_teknisi;
        ...
        $sql_assignmentticket = "SELECT COUNT(id_ticket) AS jml_assignment_ticket FROM ticket WHERE status = 3 AND id_teknisi='$id_teksnisi'";

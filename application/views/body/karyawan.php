						...
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
                           ...
                           <?php $no = 0; foreach($datakaryawan as $row) : $no++;?>
						     <tr>
						        ...
						        <td> 
									<a class="ubah btn btn-primary btn-xs" href="<?php echo base_url();?>karyawan/edit/<?php echo $row->nik;?>">
										<span class="glyphicon glyphicon-edit" ></span>
									</a>
									<a data-toggle="modal"  title="Hapus Karyawan" class="hapus btn btn-danger btn-xs" href="#modKonfirmasi" data-id="<?php echo $row->nik;?>">
